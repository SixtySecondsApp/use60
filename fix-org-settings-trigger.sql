-- ============================================================================
-- FIX: Organization Settings Change Notification Trigger
-- ============================================================================
-- Issue: The trigger was referencing a non-existent 'domain' column
-- Fix: Use correct 'company_domain' column in all references
-- Run this in Supabase SQL Editor to fix the trigger in your staging database
-- ============================================================================
...
-- Verification
SELECT 'Trigger org_settings_changed_notification has been recreated successfully!' as status;

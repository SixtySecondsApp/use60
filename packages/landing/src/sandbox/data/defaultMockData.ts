...
export const defaultProposals: SandboxProposal[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        type: 'problem',
        title: 'The Challenge',
        content: '<p>Acme Corp\'s sales team of 8 reps is experiencing three core challenges:</p><table style="width:100%; border-collapse:collapse; margin:16px 0;"><thead><tr style="border-bottom:2px solid rgba(255,255,255,0.1);"><th style="text-align:left; padding:10px 16px; font-weight:600; color:rgba(255,255,255,0.9); background:rgba(255,255,255,0.03);">Challenge</th><th style="text-align:left; padding:10px 16px; font-weight:600; color:rgba(255,255,255,0.9); background:rgba(255,255,255,0.03);">Impact</th><th style="text-align:left; padding:10px 16px; font-weight:600; color:rgba(255,255,255,0.9); background:rgba(255,255,255,0.03);">Priority</th></tr></thead><tbody><tr style="border-bottom:1px solid rgba(255,255,255,0.06);"><td style="padding:10px 16px;">Fragmented tools — 4+ apps daily</td><td style="padding:10px 16px;">Context loss and data silos</td><td style="padding:10px 16px;"><span style="color:#ef4444; font-weight:600;">High</span></td></tr><tr style="border-bottom:1px solid rgba(255,255,255,0.06);"><td style="padding:10px 16px;">Manual follow-ups — 3+ hrs/day on admin</td><td style="padding:10px 16px;">$180K annual lost productivity</td><td style="padding:10px 16px;"><span style="color:#ef4444; font-weight:600;">High</span></td></tr><tr style="border-bottom:1px solid rgba(255,255,255,0.06);"><td style="padding:10px 16px;">Pipeline blind spots</td><td style="padding:10px 16px;">Missed deals and slow decisions</td><td style="padding:10px 16px;"><span style="color:#f59e0b; font-weight:600;">Medium</span></td></tr></tbody></table>',
        order: 2,
      },
      {
        id: 'sec-001-solution',
      ...
      },
      {
        ...
        content: '<table style="width:100%; border-collapse:collapse; margin:16px 0;"><thead><tr style="border-bottom:2px solid rgba(255,255,255,0.1);"><th style="text-align:left; padding:10px 16px; font-weight:600; color:rgba(255,255,255,0.9); background:rgba(255,255,255,0.03);">Phase</th><th style="text-align:left; padding:10px 16px; font-weight:600; color:rgba(255,255,255,0.9); background:rgba(255,255,255,0.03);">Timeline</th><th style="text-align:left; padding:10px 16px; font-weight:600; color:rgba(255,255,255,0.9); background:rgba(255,255,255,0.03);">Activities</th><th style="text-align:left; padding:10px 16px; font-weight:600; color:rgba(255,255,255,0.9); background:rgba(255,255,255,0.03);">Milestone</th></tr></thead><tbody><tr style="border-bottom:1px solid rgba(255,255,255,0.06);"><td style="padding:10px 16px; font-weight:500;">Onboarding</td><td style="padding:10px 16px;">Week 1-2</td><td style="padding:10px 16px;">CRM migration, calendar/email integration, team provisioning</td><td style="padding:10px 16px; color:#37bd7e;">Go live</td></tr><tr style="border-bottom:1px solid rgba(255,255,255,0.06);"><td style="padding:10px 16px; font-weight:500;">Training</td><td style="padding:10px 16px;">Week 3-4</td><td style="padding:10px 16px;">Team sessions (2x1hr), meeting intelligence config, pipeline setup</td><td style="padding:10px 16px; color:#37bd7e;">Team activated</td></tr><tr style="border-bottom:1px solid rgba(255,255,255,0.06);"><td style="padding:10px 16px; font-weight:500;">Optimization</td><td style="padding:10px 16px;">Week 5-8</td><td style="padding:10px 16px;">AI tone calibration, workflow automation, performance review</td><td style="padding:10px 16px; color:#37bd7e;">Full ROI</td></tr></tbody></table>',
        order: 4,
      },
      {
        id: 'sec-001-pricing',
        type: 'pricing',
        title: 'Investment',
        content: '<p><strong>Enterprise Plan — 8 seats</strong></p><table style="width:100%; border-collapse:collapse; margin:16px 0;"><thead><tr style="border-bottom:2px solid rgba(255,255,255,0.1);"><th style="text-align:left; padding:10px 16px; font-weight:600; color:rgba(255,255,255,0.9); background:rgba(255,255,255,0.03);">Item</th><th style="text-align:right; padding:10px 16px; font-weight:600; color:rgba(255,255,255,0.9); background:rgba(255,255,255,0.03);">Annual Cost</th></tr></thead><tbody><tr style="border-bottom:1px solid rgba(255,255,255,0.06);"><td style="padding:10px 16px;">Platform License (8 seats)</td><td style="text-align:right; padding:10px 16px;">$76,800</td></tr><tr style="border-bottom:1px solid rgba(255,255,255,0.06);"><td style="padding:10px 16px;">Meeting Intelligence Add-on</td><td style="text-align:right; padding:10px 16px;">$9,600</td></tr><tr style="border-bottom:1px solid rgba(255,255,255,0.06);"><td style="padding:10px 16px;">Dedicated Onboarding</td><td style="text-align:right; padding:10px 16px;">$4,800</td></tr><tr style="border-bottom:1px solid rgba(255,255,255,0.06);"><td style="padding:10px 16px;">Priority Support (Year 1)</td><td style="text-align:right; padding:10px 16px;">$3,800</td></tr><tr style="border-top:2px solid rgba(255,255,255,0.15);"><td style="padding:10px 16px; font-weight:700;">Total Investment</td><td style="text-align:right; padding:10px 16px; font-weight:700; color:#37bd7e;">$95,000</td></tr></tbody></table><p style="margin-top:12px; padding:12px 16px; background:rgba(55,189,126,0.08); border:1px solid rgba(55,189,126,0.15); border-radius:8px; font-size:0.875rem;"><strong>90-day pilot available</strong> — $28,500 for a 3-month commitment (3 seats) to prove ROI before full engagement.</p>',
        order: 5,
      },
      {
        id: 'sec-001-terms',
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        type: 'pricing',
        title: 'Investment',
        content: '<p><strong>Growth Plan — 4 seats</strong></p><table style="width:100%; border-collapse:collapse; margin:16px 0;"><thead><tr style="border-bottom:2px solid rgba(255,255,255,0.1);"><th style="text-align:left; padding:10px 16px; font-weight:600; color:rgba(255,255,255,0.9); background:rgba(255,255,255,0.03);">Item</th><th style="text-align:right; padding:10px 16px; font-weight:600; color:rgba(255,255,255,0.9); background:rgba(255,255,255,0.03);">Annual Cost</th></tr></thead><tbody><tr style="border-bottom:1px solid rgba(255,255,255,0.06);"><td style="padding:10px 16px;">Platform License (4 seats)</td><td style="text-align:right; padding:10px 16px;">$38,400</td></tr><tr style="border-bottom:1px solid rgba(255,255,255,0.06);"><td style="padding:10px 16px;">Meeting Intelligence</td><td style="text-align:right; padding:10px 16px;">$4,800</td></tr><tr style="border-bottom:1px solid rgba(255,255,255,0.06);"><td style="padding:10px 16px;">Onboarding Package</td><td style="text-align:right; padding:10px 16px;">$4,800</td></tr><tr style="border-top:2px solid rgba(255,255,255,0.15);"><td style="padding:10px 16px; font-weight:700;">Total</td><td style="text-align:right; padding:10px 16px; font-weight:700; color:#37bd7e;">$48,000</td></tr></tbody></table>',
        order: 2,
      },
    ],
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        type: 'pricing',
        title: 'Investment',
        content: '<p><strong>Enterprise Consulting — 10 seats</strong></p><table style="width:100%; border-collapse:collapse; margin:16px 0;"><thead><tr style="border-bottom:2px solid rgba(255,255,255,0.1);"><th style="text-align:left; padding:10px 16px; font-weight:600; color:rgba(255,255,255,0.9); background:rgba(255,255,255,0.03);">Item</th><th style="text-align:right; padding:10px 16px; font-weight:600; color:rgba(255,255,255,0.9); background:rgba(255,255,255,0.03);">Annual Cost</th></tr></thead><tbody><tr style="border-bottom:1px solid rgba(255,255,255,0.06);"><td style="padding:10px 16px;">Platform License (10 seats)</td><td style="text-align:right; padding:10px 16px;">$84,000</td></tr><tr style="border-bottom:1px solid rgba(255,255,255,0.06);"><td style="padding:10px 16px;">Custom Workflow Design</td><td style="text-align:right; padding:10px 16px;">$18,000</td></tr><tr style="border-bottom:1px solid rgba(255,255,255,0.06);"><td style="padding:10px 16px;">Training & Enablement</td><td style="text-align:right; padding:10px 16px;">$12,000</td></tr><tr style="border-bottom:1px solid rgba(255,255,255,0.06);"><td style="padding:10px 16px;">Priority Support</td><td style="text-align:right; padding:10px 16px;">$6,000</td></tr><tr style="border-top:2px solid rgba(255,255,255,0.15);"><td style="padding:10px 16px; font-weight:700;">Total</td><td style="text-align:right; padding:10px 16px; font-weight:700; color:#37bd7e;">$120,000</td></tr></tbody></table>',
        order: 2,
      },
    ],
  },

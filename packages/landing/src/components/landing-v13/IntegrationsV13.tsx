...
const INTEGRATIONS: Integration[] = [
  ...
  { name: 'LinkedIn', domain: 'linkedin.com', description: 'Profile enrichment and connection tracking', category: 'Outreach', comingSoon: true },
  // Phone & Billing

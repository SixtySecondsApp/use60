...
import { Mail, Calendar, Target, Activity, Search, LayoutDashboard } from 'lucide-react';
...
const FEATURES: Feature[] = [
  ...
  },
  {
    ...
    description:
      'Dynamic tables, voice commands, AI enrichment, and automated outreach \u2014 all in one screen. Tell 60 what you need and watch it happen.',
    skills: ['Ops tables', 'Voice commands', 'AI enrichment', 'Sequence builder', 'CRM sync', 'Multi-source data'],
    count: '12 skills',
  },
];
...
export function FeatureGridV13() {
  return (
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          ...
          <p className="mt-4 text-gray-500 dark:text-gray-400 text-lg font-body max-w-2xl mx-auto">
            From meeting prep to deal rescue, 60 has a workflow ready.
          </p>
        </motion.div>

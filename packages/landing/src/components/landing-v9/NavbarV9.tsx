...
import { ThemeToggleV9 } from './ThemeToggleV9';
...
export function NavbarV9({ isDark, onToggleTheme }: NavbarV9Props) {
    ...
    >
      <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <ThemeToggleV9 isDark={isDark} onToggle={onToggleTheme} />
          <a

...
import { FileText, Mic, Mail } from 'lucide-react';
...
/* ------------------------------------------------------------------ */
/*  Mockup components (same as V8, wrapped with tilt)                  */
/* ------------------------------------------------------------------ */
...
function MeetingPrepMockup() {
  return (
    <TiltWrapper>
      <div className="bg-white dark:bg-[#111] border border-gray-200 dark:border-white/10 rounded-xl p-5 shadow-sm text-left overflow-hidden">
...
export function FeatureNarrativeV9() {
  return (

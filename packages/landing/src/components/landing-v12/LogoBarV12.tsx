...
export function LogoBarV12() {
  return (
    <section className="bg-white dark:bg-[#0c1222] py-16 border-b border-gray-100 dark:border-white/[0.08]">
      <motion.div
      ...
      >
        <p className="text-center text-sm font-medium text-gray-400 dark:text-[#8891b0] mb-10">

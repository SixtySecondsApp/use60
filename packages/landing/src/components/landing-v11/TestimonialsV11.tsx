...
const TESTIMONIALS: Testimonial[] = [
  ...
  {
    quote:
      "I was about to hire a sales leader for $120K. Instead we invested in 60. Three months later, pipeline is 3x and we didn't add a single person.",
    author: 'Grace E.',
    role: 'COO, Financial Services ($7M revenue)',
  },
  {
    quote:
      "The command center changed everything. Voice command to find leads, enrich them, write sequences, and push to LinkedIn — all in one screen. My head nearly exploded.",
    author: 'David L.',

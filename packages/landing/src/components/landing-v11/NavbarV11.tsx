...
import { ThemeToggleV11 } from './ThemeToggleV11';
...
export function NavbarV11({ isDark, onToggleTheme }: NavbarV11Props) {
    ...
    >
      <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <ThemeToggleV11 isDark={isDark} onToggle={onToggleTheme} />
          <a

...
const PERSONAS: Persona[] = [
  ...
  {
    icon: BarChart3,
    title: 'COO / Revenue Leader',
    pain: "Need to triple revenue but can't keep hiring. Last sales leader didn't work out. Need a system, not a person.",
    solution:
      '60 becomes your AI sales operations layer. Custom-built for your stack, live in 48 hours, getting smarter every week.',
    feature: 'Custom command center built for your exact workflow',
  },
  {
    icon: Users,
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          ...
          <h2 className="font-display font-bold text-3xl md:text-5xl text-gray-900 dark:text-white tracking-tight">
            Whether you're closing deals or scaling revenue.
          </h2>

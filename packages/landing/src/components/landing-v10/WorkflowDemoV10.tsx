...
import { Check, MessageSquare, Brain, TrendingUp } from 'lucide-react';
      ...
      <div className="flex items-center justify-center gap-[3px] h-8">
        {Array.from({ length: 12 }).map((_, i) => (
          <div
            ...
            style={{
              animation: isActive ? `waveform-v10 0.8s ease-in-out infinite` : 'none',
...
export function WorkflowDemoV10() {
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          ...
          <p className="mt-4 text-gray-500 dark:text-zinc-400 text-lg font-body max-w-2xl mx-auto">
            Watch how 60 works across every stage of the deal — from research to intelligence.
          </p>
        </motion.div>

/**
 * InteractiveDemoV22 — Hover-pause bug fix (#0)
 *
 * Fix: Mouse handlers moved from the outer flex container (which wraps
 * both step cards + viewport) to just the step list container. This
 * prevents the entire "How it works" section from pausing when the
 * cursor enters the viewport area.
 *
 * All chapter demos, animations, and behavior unchanged from V20.
 */
...
// ═══════════════════════════════════════════════════════════
//  CHAPTER 3: Record Meetings — Call capture
// ═══════════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════════
//  CHAPTER 4: Analyze Meetings — Radar Ping (#8)
// ═══════════════════════════════════════════════════════════
    ...
    <motion.div {...demoEnter} className="relative">
      <div className={`space-y-2 transition-all duration-300 ${showModal ? 'opacity-30 blur-[1px] scale-[0.99]' : ''}`}>
        ...
        <div className="rounded-lg border border-[#E2E8F0] dark:border-gray-700/50 overflow-hidden bg-white dark:bg-white/[0.02]">
          {[
            { name: 'Q2 Strategy — Campium', time: 'Today, 2:30 PM', duration: '32 min', sentiment: 'Positive' },
            { name: 'Product Demo — ScaleOps', time: 'Yesterday, 11:00 AM', duration: '45 min', sentiment: 'Neutral' },
            { name: 'Intro Call — DataForge', time: 'Mon, 3:15 PM', duration: '22 min', sentiment: 'Positive' },
          ].map((m, i) => (
...
// ═══════════════════════════════════════════════════════════
//  Main Component — V22: Hover-pause fix
// ═══════════════════════════════════════════════════════════

export function InteractiveDemoV22() {
    ...
    <div id="demo">
        <section ref={sectionRef} className="relative bg-gray-50/50 dark:bg-[#0a1020] overflow-hidden py-16 md:py-20">
          ...
          <div className="relative max-w-7xl mx-auto px-6 w-full py-6 md:py-8">
            ...
            {/* V22 FIX: Mouse handlers moved to step list container only */}

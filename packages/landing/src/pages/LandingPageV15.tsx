/**
 * LandingPageV15 — V14 layout with upgraded interactive demo
 *
...
// V15 demo (upgraded from V14)
import { InteractiveDemoV15 } from '../components/landing-v15/InteractiveDemoV15';
...
export function LandingPageV15() {

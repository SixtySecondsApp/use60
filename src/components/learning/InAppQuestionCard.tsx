    ...
    >
      <Icon
        className={cn(
          ...
          selected ? 'text-indigo-400' : 'text-gray-600'
        )}
      />
...
export function InAppQuestionCard({ question, onDone, className }: InAppQuestionCardProps) {
  ...
  return (
    <div
      className={cn(
        'rounded-xl border border-gray-800 bg-gray-900/60 p-5 space-y-4',
        className
      )}
    >
      {/* Header */}
      <div className="flex items-start gap-2.5">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-sm font-medium text-gray-100 mt-0.5 leading-snug">
      ...
      <div className="space-y-2">
        ...
        {question.answer_type === 'free_text' && (
          <textarea
            ...
            className={cn(
              'w-full px-3.5 py-2.5 rounded-lg border border-gray-700 bg-gray-800/60',

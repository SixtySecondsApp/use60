...
export function SocialProofCentered({ section, onSectionClick }: SectionComponentProps) {
      ...
      <div className="py-16 md:py-24 px-6">
        <div className="max-w-3xl mx-auto text-center">
          <AssetSlot
            ...
            alt={copy.headline} className="mb-8 max-w-xs mx-auto"
          />
          <h2 className="text-3xl md:text-4xl font-bold mb-4">{copy.headline}</h2>
          <blockquote className="text-xl md:text-2xl italic opacity-80 mb-4 leading-relaxed">
            &ldquo;{copy.subhead}&rdquo;
          </blockquote>

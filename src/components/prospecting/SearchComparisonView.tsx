    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          <GitCompareArrows className="h-4 w-4 text-[#64748B]" />
      ...
      <div className="grid grid-cols-2 gap-3">
        {[entryA, entryB].map((entry, idx) => (
          <div key={entry.id} className="rounded-lg border border-[#E2E8F0] dark:border-gray-700/50 p-3 space-y-2">
            <div className="flex items-center justify-between">
            ...
            <div className="space-y-1.5">
              ...
              <div className="flex items-center gap-1.5 text-xs text-[#1E293B] dark:text-gray-100">
                <Hash className="h-3 w-3 text-[#64748B]" />
      ...
      {/* Diff stats */}
      <div className="rounded-lg border border-[#E2E8F0] dark:border-gray-700/50 p-3 space-y-3">

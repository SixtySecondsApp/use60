    ...
    <div className="flex items-center gap-1">
      ...
      {onEnrichAll && (
        <button
          ...
          className="inline-flex items-center gap-1.5 rounded-lg border border-purple-700/40 bg-purple-900/20 px-3 py-1.5 text-sm font-medium text-purple-300 transition-colors hover:bg-purple-900/40 hover:text-purple-200 disabled:opacity-50 disabled:cursor-not-allowed"
        >
          {isEnriching ? (

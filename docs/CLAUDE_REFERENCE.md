# use60 — Full Technical Reference

> **Quick reference**: See [CLAUDE.md](../CLAUDE.md) for the condensed developer guide.
> This file contains the full detailed documentation previously in CLAUDE.md.
...
- [Skills System (Full Documentation)](#skills-system-full-documentation)
- [Copilot System (Full Details)](#copilot-system-full-details)
- [MeetingBaaS Integration (Full Guide)](#meetingbaas-integration-full-guide)
- [Security Architecture (Full Documentation)](#security-architecture-full-documentation)
...
> Summary in [CLAUDE.md](../CLAUDE.md). Full details below.

> **See full PRD**: [`docs/PRD_PROACTIVE_AI_TEAMMATE.md`](PRD_PROACTIVE_AI_TEAMMATE.md)
...
## Skills System (Full Documentation)
...
## Copilot System (Full Details)

> Summary in [CLAUDE.md](../CLAUDE.md). Full details below.

### Autonomous Copilot Architecture
...
### Gemini-Powered Copilot (api-copilot)

> **Full PRD**: [`docs/PRD_PROACTIVE_AI_TEAMMATE.md`](PRD_PROACTIVE_AI_TEAMMATE.md)
...
## MeetingBaaS Integration (Full Guide)
...
## Security Architecture (Full Documentation)

> Summary in [CLAUDE.md](../CLAUDE.md). Full details below.

> **Full Documentation**: [`docs/SECURITY_HARDENING_GUIDE.md`](SECURITY_HARDENING_GUIDE.md)
> **Implementation Summary**: [`docs/SECURITY_IMPLEMENTATION_SUMMARY.md`](SECURITY_IMPLEMENTATION_SUMMARY.md)

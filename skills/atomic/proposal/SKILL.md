...
### Source 1: Business Context (Loaded)

Your business context is pre-loaded and contains your company information, services/products, case studies, testimonials, pricing structure, and differentiators. Reference this for:
- What you offer and how to describe it
- Case studies and social proof to include
- Standard pricing, tiers, and payment terms
- Your company's tone and positioning
...
3. **The solution** — what you're proposing, mapped to your offerings
4. **The stakes** — what happens if they don't act (cost of inaction)
5. **The proof** — which of your case studies best match their situation
...
Use real constraints: team availability, pricing validity windows, seasonal factors, or market deadlines from your business context. Capacity-based urgency is honest and effective.
...
```
1. Cover / Header
   → Client name prominent, your branding subtle
...
5. Proof (Why Us)
   → 1-2 relevant case studies from your business context
...
Use the pricing structure and currency from your business context. If no pricing exists, use placeholders and recommend three tiers.

### Payment Terms

Use payment terms from your business context if available. If not, apply these defaults:
...
Check your business context for standard pricing. If none exists, write the document with `[PRICE]` placeholders and a note: "Fill in your pricing. I recommend three tiers. Here's how to structure them..." Reference `references/proposal-rules.md` for pricing psychology.

...
VALUES (
  ...
  '{
    ...
    "description": "End-to-end meeting preparation: loads meeting, fetches primary contact, generates comprehensive brief with agenda and talking points. No follow-up email.",
    "version": 1,

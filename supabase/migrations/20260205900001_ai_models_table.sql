...
VALUES
  ...
  ('anthropic', 'claude-sonnet-4-20250514', 'Claude Sonnet 4', 3.00, 15.00, 200000, 64000, true, true),
  ('anthropic', 'claude-haiku-4-5-20250514', 'Claude Haiku 4.5', 0.80, 4.00, 200000, 64000, true, true)

...
--   for the Website Visitor Intelligence feature.
--
-- Rollback strategy:
--   DROP TABLE IF EXISTS website_visitors, visitor_snippet_configs, ip_resolution_cache CASCADE;

-- =============================================================================
-- visitor_snippet_configs: per-org snippet configuration
-- =============================================================================
...
-- =============================================================================
-- website_visitors: resolved visitor records
-- =============================================================================
...
-- =============================================================================
-- ip_resolution_cache: avoid duplicate API calls for same IP within 24h
-- =============================================================================

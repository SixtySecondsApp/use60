-- =============================================================================
-- Migration: Add contact_name and contact_email to get_pipeline_with_health RPC
-- Fix: Deal copilot context missing contact info because RPC omits these fields
-- =============================================================================

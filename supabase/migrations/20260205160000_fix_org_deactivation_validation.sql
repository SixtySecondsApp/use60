-- Fix Organization Deactivation Validation Bug
-- Remove the incorrect requirement that users must have another active organization
-- Users should be able to deactivate their only organization
...
begin
  ...
  -- REMOVED: Check for other active organizations

-- Fix RPC functions that have empty search_path but use unqualified table names
-- This causes "relation does not exist" errors when the functions are called

-- =============================================================================
-- Fix: get_team_members_with_connected_accounts
-- =============================================================================

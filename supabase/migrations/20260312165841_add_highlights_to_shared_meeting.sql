-- Migration: add_highlights_to_shared_meeting
-- Date: 20260312165841
--
-- What this migration does:
--   Updates get_shared_meeting RPC to also return highlights from the recordings table.
--   Highlights are stored as jsonb on recordings.highlights.
--
-- Rollback strategy:
--   Re-run the previous version of get_shared_meeting from 20260312161513
...
BEGIN
  ...
  -- Highlights from recordings table

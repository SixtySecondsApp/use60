-- =============================================================================
-- Migration: Standard Table Health RPC
-- SOT-010: Sync health observability — per-table sync metrics
-- =============================================================================

-- Returns sync health stats for all standard tables in an org.
-- Used by the StandardTablesHealth UI component.
...
COMMENT ON FUNCTION public.get_standard_table_health IS
  'Returns sync health metrics for standard ops tables: row counts, source breakdown, conflicts, stale rows.';

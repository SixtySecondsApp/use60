-- Seed: Production Skills (10x capabilities)
-- Date: 2026-01-14
--
-- Purpose:
-- - Create 5 production-grade skills that leverage real integrations
-- - Each skill declares required capabilities and uses execute_action for data gathering
-- - Emits strict SkillResult contracts for reliable machine consumption

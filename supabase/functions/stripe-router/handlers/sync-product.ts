// supabase/functions/stripe-router/handlers/sync-product.ts
...
export async function handleSyncProduct(req: Request): Promise<Response> {
  try {
    ...
    await captureException(error, {
      tags: {
        function: 'stripe-router/sync_product',
        integration: 'stripe',
      },
    });

// supabase/functions/stripe-router/handlers/update-product.ts
...
export async function handleUpdateProduct(req: Request): Promise<Response> {
  try {
    ...
    await captureException(error, {
      tags: {
        function: 'stripe-router/update_product',
        integration: 'stripe',
      },
    });

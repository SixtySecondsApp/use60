...
// List activities
export async function handleActivitiesList(client: any, url: URL, userId: string, permissions: any) {
  try {
...
// Get single activity
export async function handleSingleActivity(client: any, activityId: string, userId: string, permissions: any) {
  try {
...
// Create activity
export async function handleCreateActivity(client: any, body: any, userId: string) {
  try {
...
// Update activity
export async function handleUpdateActivity(client: any, activityId: string, body: any, userId: string, permissions: any) {
  try {
    if (!isValidUUID(activityId)) {
      return createErrorResponse('Invalid activity ID format', 400, 'INVALID_ID_FORMAT')
    }
...
// Delete activity
export async function handleDeleteActivity(client: any, activityId: string, userId: string, permissions: any) {
  try {
    if (!isValidUUID(activityId)) {
      return createErrorResponse('Invalid activity ID format', 400, 'INVALID_ID_FORMAT')
    }

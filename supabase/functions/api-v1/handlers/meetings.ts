...
// List meetings
export async function handleMeetingsList(client: any, url: URL, userId: string, permissions: any) {
  try {
...
// Get single meeting
export async function handleSingleMeeting(client: any, meetingId: string, userId: string, permissions: any) {
  try {
...
// Create meeting
export async function handleCreateMeeting(client: any, body: any, userId: string) {
  try {
...
// Update meeting
export async function handleUpdateMeeting(client: any, meetingId: string, body: any, userId: string, permissions: any) {
  try {
    if (!isValidUUID(meetingId)) {
      return createErrorResponse('Invalid meeting ID format', 400, 'INVALID_ID_FORMAT')
    }
...
// Delete meeting
export async function handleDeleteMeeting(client: any, meetingId: string, userId: string, permissions: any) {
  try {
    if (!isValidUUID(meetingId)) {
      return createErrorResponse('Invalid meeting ID format', 400, 'INVALID_ID_FORMAT')
    }

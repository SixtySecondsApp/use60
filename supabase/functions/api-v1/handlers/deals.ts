...
// List deals
export async function handleDealsList(client: any, url: URL, userId: string, permissions: any) {
  try {
...
// Get single deal
export async function handleSingleDeal(client: any, dealId: string, userId: string, permissions: any) {
  try {
...
// Create deal
export async function handleCreateDeal(client: any, body: any, userId: string) {
  try {
...
// Update deal
export async function handleUpdateDeal(client: any, dealId: string, body: any, userId: string, permissions: any) {
  try {
    if (!isValidUUID(dealId)) {
      return createErrorResponse('Invalid deal ID format', 400, 'INVALID_ID_FORMAT')
    }
...
// Delete deal
export async function handleDeleteDeal(client: any, dealId: string, userId: string, permissions: any) {
  try {
    if (!isValidUUID(dealId)) {
      return createErrorResponse('Invalid deal ID format', 400, 'INVALID_ID_FORMAT')
    }

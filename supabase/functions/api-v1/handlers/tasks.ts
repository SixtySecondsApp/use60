...
// List tasks
export async function handleTasksList(client: any, url: URL, userId: string, permissions: any) {
  try {
...
// Get single task
export async function handleSingleTask(client: any, taskId: string, userId: string, permissions: any) {
  try {
...
// Create task
export async function handleCreateTask(client: any, body: any, userId: string) {
  try {
...
// Update task
export async function handleUpdateTask(client: any, taskId: string, body: any, userId: string, permissions: any) {
  try {
    if (!isValidUUID(taskId)) {
      return createErrorResponse('Invalid task ID format', 400, 'INVALID_ID_FORMAT')
    }
...
// Delete task
export async function handleDeleteTask(client: any, taskId: string, userId: string, permissions: any) {
  try {
    if (!isValidUUID(taskId)) {
      return createErrorResponse('Invalid task ID format', 400, 'INVALID_ID_FORMAT')
    }

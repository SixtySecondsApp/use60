...
export async function handleBullhornAdmin(req: Request): Promise<Response> {
  ...
  try {
    ...
    const action: Action | null = typeof (body.sub_action ?? body.action) === 'string' ? ((body.sub_action ?? body.action) as Action) : null

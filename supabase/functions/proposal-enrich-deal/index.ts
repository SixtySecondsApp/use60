...
//
// Triggered fire-and-forget from proposal-pipeline-v2 after the proposal
// reaches 'ready' status. Runs company-research skill, updates deal + contact
// records, and posts enrichment summary to the deal room.
//
...
serve(async (req: Request) => {
  ...
  try {
    ...
    //    Threaded under the briefing message if briefing_slack_ts is available.
    // -----------------------------------------------------------------------
    try {

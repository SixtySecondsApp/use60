/**
 * Handler: sales-assistant
 * Extracted from supabase/functions/slack-sales-assistant/index.ts
 */
...
export async function handleSalesAssistant(req: Request): Promise<Response> {

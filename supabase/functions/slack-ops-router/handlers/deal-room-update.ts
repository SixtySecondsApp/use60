/**
 * Handler: deal-room-update
 * Extracted from supabase/functions/slack-deal-room-update/index.ts
 */
...
export async function handleDealRoomUpdate(req: Request): Promise<Response> {

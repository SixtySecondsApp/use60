/**
 * Handler: refresh-user-channels
 * Extracted from supabase/functions/slack-refresh-user-channels/index.ts
 */
...
export async function handleRefreshUserChannels(req: Request): Promise<Response> {

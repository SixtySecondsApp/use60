/**
 * Handler: email-reply-alert
 * Extracted from supabase/functions/slack-email-reply-alert/index.ts
 */
...
export async function handleEmailReplyAlert(req: Request): Promise<Response> {

/**
 * Handler: deal-risk-alert
 * Extracted from supabase/functions/slack-deal-risk-alert/index.ts
 */
...
export async function handleDealRiskAlert(req: Request): Promise<Response> {

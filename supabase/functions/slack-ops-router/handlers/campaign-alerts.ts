/**
 * Handler: campaign_alerts
 * Extracted from supabase/functions/slack-campaign-alerts/index.ts
 */
...
export async function handleCampaignAlerts(req: Request): Promise<Response> {

/**
 * Handler: hitl-notification
 * Extracted from supabase/functions/slack-hitl-notification/index.ts
 */
...
export async function handleHitlNotification(req: Request): Promise<Response> {

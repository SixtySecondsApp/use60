/**
 * Handler: copilot-actions
 * Extracted from supabase/functions/slack-copilot-actions/index.ts
 */
...
export async function handleCopilotActions(req: Request): Promise<Response> {

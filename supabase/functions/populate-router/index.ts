...
import { handleAttioColumn } from './handlers/attio_column.ts'
import { handleHubspotColumn } from './handlers/hubspot_column.ts'

const HANDLERS: Record<string, (req: Request) => Promise<Response>> = {
  attio_column: handleAttioColumn,
  hubspot_column: handleHubspotColumn,
}
...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    console.error('[populate-router] Router error:', error)

/**
 * Handler: generate-icp-profiles
 * Uses Claude to generate ICP profiles with Apollo-compatible filters.
 */
...
export async function handleIcpProfiles(req: Request): Promise<Response> {

/**
 * Handler: fact_profile_context
 * Extracted from sync-fact-profile-context/index.ts
 *
...
import { getCorsHeaders, jsonResponse } from '../../_shared/corsHelper.ts'
...
export async function handleFactProfileContext(req: Request): Promise<Response> {
  try {
    if (req.method !== 'POST') {

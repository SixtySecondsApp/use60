/**
 * Handler: aggregate_insights_query
 * Extracted from meeting-aggregate-insights-query
 *
...
export async function handleAggregateInsightsQuery(req: Request): Promise<Response> {

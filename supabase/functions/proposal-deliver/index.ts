...
//
// Responsibilities:
//   1. Create activity record (type: proposal_generated)
//   2. Send Slack DM to rep with PDF download link
//   3. Update proposals.status to 'ready'
//   4. If autonomy_tier is 'auto': queue client notification with undo window
//   5. Credit cost: 0–0.5 credits (notification only)

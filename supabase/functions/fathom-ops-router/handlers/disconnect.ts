/**
 * Handler: disconnect
 * Extracted from fathom-disconnect edge function.
 *
 * Allows any user to disconnect their own Fathom integration.
 * Optionally deletes all Fathom-synced meetings owned by that user.
 */

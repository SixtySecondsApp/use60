/**
 * Handler: update_user_mapping
 * Extracted from fathom-update-user-mapping edge function.
 *
...
export async function handleUpdateUserMapping(req: Request): Promise<Response> {

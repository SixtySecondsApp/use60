// Handler: research-fact-profile (consolidated into research-router-v2)
...
export async function handleFactProfile(req: Request): Promise<Response> {
  ...
  try {
    ...
    // body.action is the router-level action ('fact_profile').

// Handler: research-orchestrator (consolidated into research-router-v2)
// Queue Management + Credit Reservation for batch research requests
...
export async function handleOrchestrator(req: Request): Promise<Response> {
  try {
    // ------------------------------------------------------------------

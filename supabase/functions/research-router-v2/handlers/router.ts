// Handler: research-router (consolidated into research-router-v2)
// Processes individual agent_run tasks with provider routing and LLM extraction

import { createClient } from 'https://esm.sh/@supabase/supabase-js@2.43.4'
import { getCorsHeaders, errorResponse, jsonResponse } from '../../_shared/corsHelper.ts'
...
export async function handleRouter(req: Request): Promise<Response> {
  try {

/**
 * Skill Builder handler — extracted from api-skill-builder/index.ts
 */
...
export async function handleSkillBuilder(req: Request): Promise<Response> {

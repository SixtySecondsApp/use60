/**
 * Usage Alerts handler — extracted from api-usage-alerts/index.ts
 */
...
export async function handleUsageAlerts(req: Request): Promise<Response> {
                  ...
                  blocks: [
                    {
                      ...
                      text: {
                        type: 'plain_text',
                        text: `API Usage Alert: ${threshold}% Threshold`,
                        emoji: true,
                      },
                    },
                    {

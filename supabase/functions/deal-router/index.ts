...
import { handleAnalyzeRiskSignals } from './handlers/analyze_risk_signals.ts'
import { handleMemory } from './handlers/memory.ts'
import { handleSplits } from './handlers/splits.ts'

const HANDLERS: Record<string, (req: Request) => Promise<Response>> = {
  activities: handleActivities,
  analyze_risk_signals: handleAnalyzeRiskSignals,
  memory: handleMemory,
  splits: handleSplits,
}
...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    console.error('[deal-router] Router error:', error)

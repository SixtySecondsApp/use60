/**
 * Proactive Task Analysis Handler
 *
 * PROACTIVE-004: Analyze overdue tasks, offer to complete or reschedule.
 *
 * Extracted from proactive-task-analysis/index.ts for the proactive-router.
 *
...
export async function handleTaskAnalysis(req: Request): Promise<Response> {

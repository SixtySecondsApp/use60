/**
 * Proactive Signal Scanner Handler
 *
 * Scans for pipeline signals (close date approaching, stale proposals,
 * dormant threads, buyer commitments due) and fires them to task-signal-processor.
 *
 * Extracted from proactive-signal-scanner/index.ts for the proactive-router.
 */
...
export async function handleSignalScanner(req: Request): Promise<Response> {
  try {

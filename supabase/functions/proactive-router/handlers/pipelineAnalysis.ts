/**
 * Proactive Pipeline Analysis Handler (enhanced — BRF-007)
 *
 * Daily analysis of pipeline health with enhanced morning briefing.
 *
 * Extracted from proactive-pipeline-analysis/index.ts for the proactive-router.
 *
...
export async function handlePipelineAnalysis(req: Request): Promise<Response> {

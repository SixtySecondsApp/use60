-- HOTFIX: Fix invitation FK constraint violation
-- Apply this directly via Supabase Dashboard SQL Editor
-- Environment: Production (ygdpgliavpxeugaajgrb)

-- =====================================================
-- CRITICAL: Fix complete_invite_signup
-- =====================================================
...
BEGIN
  ...
  -- This prevents FK constraint violation "organization_memberships_profiles_fk"
...
-- =====================================================
-- CRITICAL: Fix accept_org_invitation
-- =====================================================

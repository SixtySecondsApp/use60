...
import type { MockAgentState, TimelineEntry } from './types';
...
const SCENARIO_DATA: Record<string, MockScenarioData> = {
  ...
  'inbound-lead-rush': {
    singleAgent: {
      ...
      response:
        'Webinar leads processed (26 tool calls). 14 leads scored: 5 strong ICP fit, 6 moderate, 3 poor fit. Top leads enriched. 6 personalized follow-up emails drafted. 3-touch task cadence created for top 7 leads.',
    },
    multiAgent: {
      agents: [
        {
      ...
      response:
        'Webinar leads handled — 4 agents, 26 tools. 14 leads scored: 5 strong ICP, 6 moderate, 3 poor. All enriched. 6 personalized emails ready. 3-touch task cadence built for the top 7.',
    },
  },
  ...
  'monthly-sales-review': {
    singleAgent: {
      ...
      response:
        'Monthly review prep done (22 tool calls). $890k pipeline, $340k weighted forecast, 58% close rate. 23 external meetings, top 5 deals checked. Talking points drafted.',
    },
    multiAgent: {
      agents: [
        {
      ...
      response:
        'Review prep ready — 4 agents pulled everything. Pipeline: $890k total, $340k weighted, 58% close rate. Meetings: 23 external. Top 5 deals checked with enrichment. Talking points drafted.',
    },
  },
  ...
  'cold-outbound-sprint': {
    singleAgent: {
      ...
      response:
        'Outbound list built from scratch (28 tool calls). 25 marketing agencies found. All decision-makers enriched. Top 8 personalized emails drafted. Follow-up task sequence created for all 25.',
    },
    multiAgent: {
      agents: [
        {
      ...
      response:
        'Outbound machine built — 4 agents, 28 tools. 25 agencies found and enriched. Top 8 cold emails ready. 3-touch follow-up cadence created for all 25.',
    },
  },
  ...
  'stalled-deal-recovery': {
    singleAgent: {
      ...
      response:
        'Stalled deal analysis done (27 tool calls). 7 deals ($285k total) investigated. Re-engagement emails drafted for all 7. Status notes logged. Next-step tasks created.',
    },
    multiAgent: {
      agents: [
        {
      ...
      response:
        'Stalled deals investigated — 4 agents, 27 tools. 7 deals ($285k) analyzed. Re-engagement emails drafted with deal-specific hooks. Notes logged, tasks created.',
    },
  },
  ...
  'end-of-day-wrap': {
    singleAgent: {
      ...
      response:
        'Day wrapped up (25 tool calls). 5 meetings logged. 3 deal stages updated. 5 follow-up emails drafted. Tomorrow\'s priorities set.',
    },
    multiAgent: {
      agents: [
        {
      ...
      response:
        'Day closed out — 4 agents, 25 tools. 5 meetings logged. 3 stages updated. 5 follow-up emails drafted. Tomorrow\'s top 3 priorities set.',
    },
  },
};
